...
int main(int argc, char **argv) {
    ...
    random_host_tensor<fp8>(hB, n * k);
    // for (int i = 0; i < 128; i++) {
    //     hA[i] = __hip_cvt_float_to_fp8(1.0f, __HIP_SATFINITE, __HIP_E4M3_FNUZ);
    //     // hB[i] = __hip_cvt_float_to_fp8(2.0f, __HIP_SATFINITE, __HIP_E4M3_FNUZ);
    // }
